...
from dingo.model.prompt.prompt_rag_faithfulness import PromptRAGFaithfulness
...
class LLMRAGFaithfulness(BaseOpenAI):
    ...
    def build_messages(cls, input_data: Data) -> List:
        ...
        # 构建prompt内容
        prompt_content = cls.prompt.content.format(question, answer, combined_contexts)
