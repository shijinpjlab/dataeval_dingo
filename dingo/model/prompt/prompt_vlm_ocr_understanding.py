...
@Model.prompt_register("VLM_OCR_UNDERSTANDING", [], ['LLMVLMOCRUnderstanding'])
class PromptVLMOCRUnderstanding(BasePrompt):
    """
    ...
    content = """你是一名专业的多模态模型评估专家,擅长评估视觉语言模型(VLM)对图片中文字内容的识别和理解能力。
